...
pub struct DatabaseDetailsResponse {
    ...
    pub roots: ::prost::alloc::vec::Vec<database_details_response::DatabaseDetailsRoot>,
}
/// Nested message and enum types in `DatabaseDetailsResponse`.
pub mod database_details_response {
    #[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
